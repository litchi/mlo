...
inoremap <C-BS> bdwi
inoremap <S-F7> :so $HOME/editor/backup/Session.vim
inoremap <F7> :mksession! $HOME/editor/backup/Session.vim
map! <F11> :onlyi
map! <S-F11> -i
map! <S-F12> :tabp
map! <C-F12> :tabn
...
vnoremap <silent> \E :call EasyMotionEW(1, 0)
onoremap <silent> \E :call EasyMotionEW(0, 0)
nnoremap <silent> \E :call EasyMotionEW(0, 0)
vnoremap <silent> \B :call EasyMotionWBW(1, 1)
onoremap <silent> \B :call EasyMotionWBW(0, 1)
nnoremap <silent> \B :call EasyMotionWBW(0, 1)
vnoremap <silent> \W :call EasyMotionWBW(1, 0)
onoremap <silent> \W :call EasyMotionWBW(0, 0)
nnoremap <silent> \W :call EasyMotionWBW(0, 0)
...
vnoremap <silent> \t :call EasyMotionT(1, 0)
onoremap <silent> \t :call EasyMotionT(0, 0)
nnoremap <silent> \t :call EasyMotionT(0, 0)
...
vnoremap <silent> \gE :call EasyMotionEW(1, 1)
onoremap <silent> \gE :call EasyMotionEW(0, 1)
nnoremap <silent> \gE :call EasyMotionEW(0, 1)
...
nnoremap <SNR>15_SelectAll :exe "norm gg" . (&slm == "" ? "VG" : "gH\G")
map <S-F8> :execute RotateColorTheme()
map <C-BS> bdw
map <S-F7> :so $HOME/editor/backup/Session.vim
map <F7> :mksession! $HOME/editor/backup/Session.vim
map <F11> :only
map <S-F11> -
map <S-F12> :tabp
map <C-F12> :tabn
map <F12> w
nnoremap <silent> <F4> :Tlist
map <M-F2> :tabedit
map <M-F1> :tabclose
vmap <BS> "-d
map!  I
cmap  <Plug>CmdlineCompleteForward
imap  A
inoremap  <Del>
imap <silent>  <Plug>SwitchOption
cmap  <Plug>CmdlineCompleteBackward
let &cpo=s:cpo_save
unlet s:cpo_save
set paste
set background=dark
...
set langmenu=none
set laststatus=2
set makeprg=ant\ \ -buildfile\ ~/Text/Projects/BB10/gtd/main-stream/build.xml\ clean\ deploy
set mouse=a
set omnifunc=javascriptcomplete#CompleteJS
set printexpr=system('open\ -a\ Preview\ '.v:fname_in)\ +\ v:shell_error
set runtimepath=~/editor/vim,/Applications/MacVim.app/Contents/Resources/vim/runtime
set scrolloff=5
set shiftwidth=4
set showcmd
set showtabline=2
...
set sidescrolloff=5
set smarttab
set statusline=%F%m%r%h%w\ [%{&ff}]\ [%Y]\ [%{&fileencoding}]\ [%03.3b\ %02.2B]\ [%02v\ %03l\ %L\ %p%%]\ %{VimBuddy()}
set tabstop=4
set tags=./tags,tags;
...
silent only
cd ~/Text/Projects/BB10/gtd/main-stream
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +71 ~/editor/vim/config/setting.vim
badd +2 ~/editor/vim/config/function.vim
badd +36 edit-task.html
badd +1 build.xml
badd +22 edit-project.html
badd +1 css/main.css
badd +48 ~/Text/Projects/BB10/gtd/samples/input.htm
badd +65 ~/Text/Projects/BB10/gtd/samples/index.htm
badd +12 index.html
badd +16 edit-tag.html
badd +16 elements/actionbar.html
badd +19 task-by-tag.html
badd +19 task-by-project.html
badd +10 css/edit-object.css
badd +8 css/task-group.css
badd +3 js/task-group.js
badd +24 task-by-due.html
badd +285 ~/editor/vim/plugin/ant_menu.vim
badd +2 elements/create-task-input.html
badd +17 task-list.html
badd +12 task-by-context.html
badd +0 elements/config.xml
badd +11 config.xml
badd +20 js/task-list.js
args \[BufExplorer]
edit js/task-list.js
...
exe 'vert 2resize ' . ((&columns * 143 + 88) / 177)
argglobal
enew
file NERD_tree_6
setlocal keymap=
