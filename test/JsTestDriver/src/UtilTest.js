...
var UtilTestCase = (function () {
    ...
    UtilTestCase.prototype.testGetPrettyDateStr = function () {
        ...
        myDate.setYear(1970);
        assertEquals('Pretty date str for past date', '1970/' + (myDate.getMonth() + 1) + "/" + myDate.getDate() + " " + t, Util.getPrettyDateStr(myDate));
        myDate.setMonth(now.getMonth() + 1);
        myDate.setYear(now.getYear());
        assertEquals('Pretty date str for future date with different month', now.getYear() + '/' + (myDate.getMonth() + 1) + "/" + myDate.getDate() + " " + t, Util.getPrettyDateStr(myDate));
        myDate.setHours(1);
        myDate.setMinutes(9);
        assertEquals('Pretty date str for future date with one digit time', now.getYear() + '/' + (myDate.getMonth() + 1) + "/" + myDate.getDate() + " 01:09", Util.getPrettyDateStr(myDate));
        myDate.setHours(13);
        myDate.setMinutes(23);
        assertEquals('Pretty date str for future date with two digit time', now.getYear() + '/' + (myDate.getMonth() + 1) + "/" + myDate.getDate() + " 13:23", Util.getPrettyDateStr(myDate));
    };
}());
